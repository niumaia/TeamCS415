 ...
 */
public class XMLHandlerSpringer  extends DefaultHandler  {
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes)  throws SAXException {
        ...
        if (qName.equalsIgnoreCase("pam:article")) {
        ...
        }else if (qName.equalsIgnoreCase("printIsbn")) {
			bisbn = true;
	}else if (qName.equalsIgnoreCase("dc:title")) {
			btitle = true;
	}else if (qName.equalsIgnoreCase("prism:publicationDate")) {
			bpy = true;
